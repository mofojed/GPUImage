...
typedef enum {
    ...
    GPUIMAGE_NUMFILTERS
} GPUImageCarouselFilterType;

/** A simple wrapper to keep a filter and it's control values together */
@interface GPUImageFilterWrapper : NSObject

@property GPUImageOutput<GPUImageInput> *filter;
@property GPUImageCarouselFilterType filterType;
